...
final class AddNewCellView: UIView {
    
    weak var delegate: AddNewCellViewOutputProtocol?
    ...
    override init(frame: CGRect) {
        ...
        switchDate.addTarget(self, action: #selector(switchAction), for: .allTouchEvents)
...
// MARK: - AddNewCellViewConstraints
extension AddNewCellView {
...
extension AddNewCellView: UITextViewDelegate{
